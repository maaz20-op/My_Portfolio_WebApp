...
return (
    <div ref={sectionRefrence} >
        <div className="font-heading text-xl flex items-center "><h1>About Me</h1></div>
        <div className="lg:w-[50vw] w-[80vw]  px-5 py-5 bg-[#201e1e] mt-4 lg:text-sm text-xs text-[#cccccc] rounded-2xl">
